...
| Artifact | SHA-256 |
| --- | --- |
| `target/release/redsamurai-config.exe` | `1842B34E3E415CE92248C03A09F8D011805A5A222252639B7D10050773843119` |
| `target/release/OpenRedSamurai-Setup.exe` | `F42970783AFF3E437F062CD77C6C1C4C96C3BC422C751CA07D4F9EAA0235BA75` |
...
| `dist/OpenRedSamurai-v1.0.0-windows-x64.zip` | `5D54EEFF007A4D9C44F4F6C1C7CAB85CA8B70D17F922944DD72483CE67A25A85` |
| `dist/OpenRedSamurai-v1.0.0-windows-x64.zip.sha256` | `9A216A7B79EE55E6D5043541D8A2CDCA14D17B5F5D2E6A18CECBAEB4D8463869` |
